...
| **슈퍼뱅크 SuperVank** — 금융 리워드 앱 | 백엔드·인프라 (2018~2019): 준실시간 주식 동기화, 매크로 방지, 관리자 CMS | — |
...
- [AWS 청구서 분해 — 같은 계정 18.3% 감소, 그리고 그 수치가 말해주지 않는 것](https://blog.psyrenpark.com/notes/aws-cost-analysis/)
